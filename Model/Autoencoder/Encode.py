...
class Encode:
    ...
    def generate_slices(self,new_music_file_path):
        ...
        self.timer.endTimer()
        self.timer.saveResults('Spectrograms generation','results.txt',False)
    ...
    def generate_representations(self,slices):
        ...
        self.timer.endTimer()
        self.timer.saveResults('Spectrogram encoding','results.txt',False)
    ...
    def fuse_single_image(self,representations,details):
        ...
        self.timer.endTimer()
        self.timer.saveResults('Fusion generation','results.txt',False)
        return fusion
    ...
    def encode_data_fusion(self,fusion):
        ...
        self.timer.endTimer()
        self.timer.saveResults('Fusion encoding','results.txt',False)
        return fusion
    ...
    def encode(self,new_music_file_path):
        ...
        if self.audio.load_file(new_music_file_path,256)==True:
            self.timer.endTimer()
            self.timer.saveResults('Librosa load','results.txt',True)
