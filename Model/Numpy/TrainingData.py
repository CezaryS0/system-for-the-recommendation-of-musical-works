...
class TrainingData:
    ...
    def split_data(self,labels_path):
        ...
        buf_array.append(self.split_the_dataset_from_array(self.dataDict['rolloff_freq'],0.6))
        buf_array.append(self.split_the_dataset_from_array(self.dataDict['tempo_bpm'],0.6))
        buf_array.append(self.split_the_dataset_from_array(self.encode_labels('key_signature',labels_path),0.6))
        return buf_array
